...
const AppointmentScreen = ({ route, navigation }) => {
  ...
  /**
   * 2. FONKSİYON: Dinamik Saatleri Hesapla
   */
  useEffect(() => {
  ...
  return (
    <View style={styles.container}>
                    ...
                    <View style={styles.optionContent}>
                      <View style={styles.optionLeft}>
                        <View style={[
                          ...
                          selectedType?.id === type.id && styles.selectedIconContainer
                        ]}>
                          <Ionicons
                            name="time"
                            size={20}
                    ...
                    {timeSlotsStatus.length > 0 && timeSlotsStatus.some(s => s.status === 'available') ? (
                      ...
                      <View style={styles.emptyContainer}>
                        <View style={styles.emptyIconCircle}>
                          <Ionicons name="calendar-outline" size={48} color={COLORS.TEXT_LIGHT} />
                        </View>
            ...
            <View style={styles.summaryCard}>
              ...
              >
                ...
                <View style={styles.summaryRow}>
                  ...
                  <View style={styles.summaryTextContainer}>
                    <Text style={styles.summaryLabel}>Saat & Tip</Text>
                    <Text style={styles.summaryText}>{selectedTime} - {selectedType.name}</Text>
                  </View>
                </View>
                <View style={styles.summaryRow}>
                  <View style={styles.summaryIconBox}>
                  ...
                  <View style={styles.summaryTextContainer}>
                    ...
                    <Text style={styles.summaryText}>{selectedType.durationMinutes} Dakika</Text>
                  </View>
                </View>
              </LinearGradient>
            </View>
      ...
      {/* Onay Butonu (Sticky - Altta sabit) */}
      <View style={styles.footer}>
        <TouchableOpacity
          style={[
            styles.confirmButton,
            (!selectedDate || !selectedTime || !selectedType || loadingConfirm) && styles.disabledButton
          ]}
